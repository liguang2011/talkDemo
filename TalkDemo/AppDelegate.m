...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    ViewController  *basicViewController = [[ViewController alloc]init];//实例化内存后，_parentViewController-->nil
    basicViewController.view.backgroundColor = [UIColor whiteColor];
